...
Usage:
    python transform_parsed_files.py --data-dir ~/officeqa-corpus
    python transform_parsed_files.py --data-dir ~/officeqa-corpus --file treasury_bulletin_1939_01.json
"""
...
def main() -> None:
    ...
    output_dir = os.path.join(args.data_dir, "treasury_bulletins_parsed", "transformed")
